...
public class Main {
	...
	public static void main(String[] args) {
		...
		produto v = new produto ("Velotron"," bicicleta mínuscula que muita gente queria ter, mas não teve","R$ 40","7%", 11);
		...
		int menu, quantidade, sair;
		String nome, endereco, telefone, nomeDoProduto, descricao, valorDeCompra, porcentagem;
...
//				 cliente.pesquisarNome(nome);
				 ...
				 //adicionar a parte de mudar os dados ou seguir reto
				 break;
...
//				 System.out.println(cliente.imprimirCliente(cliente.getClienteLista().get(3)));
				 break;
